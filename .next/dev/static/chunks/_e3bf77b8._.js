...
// Утиліти для роботи з авторизацією та токеном
...
const BasketPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BasketPage.useEffect": ()=>{
            setAuthenticated((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAuthenticated"])());
        }
    }["BasketPage.useEffect"], []);
    const handleLogout = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["removeToken"])();
    ...
    const sendOrder = async ()=>{
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAuthenticated"])()) {
            alert('Будь ласка, авторизуйтесь для оформлення замовлення');
            router.push('/login');
            return;
        }
        const orderData = {
        ...
        try {
            console.log("Надсилаємо замовлення:", orderData);
            const res = await fetch("https://creator-store-server.onrender.com/api/orders", {
                method: "POST",
                headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAuthHeaders"])(),
            ...
            if (res.ok) {
                ...
                if (res.status === 401) {
                    alert('Сесія закінчилась. Будь ласка, авторизуйтесь знову');
                    router.push('/login');
                } else {
...
_s(BasketPage, "1NUgb0iHIcJd3z9pch/9OfVp0X8=", false, function() {
    return [
...
//# sourceMappingURL=_e3bf77b8._.js.map