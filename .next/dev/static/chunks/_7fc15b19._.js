...
const LoginPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginPage.useEffect": ()=>{
            ...
            // Додати скрипт Telegram Login Widget
            const script = document.createElement('script');
            script.src = 'https://telegram.org/js/telegram-widget.js?22';
            script.setAttribute('data-telegram-login', 'ТУТ_BOT_USERNAME'); // TODO: Замінити на реальний bot username
            ...
            window.onTelegramAuth = ({
                "LoginPage.useEffect": async (user)=>{
                    console.log('Отримані дані від Telegram:', user);
                    try {
                        // Відправити дані на бекенд для отримання токену
                        const response = await fetch('https://creator-store-server.onrender.com/api/auth/telegram', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json'
                            },
                        ...
                        if (response.ok) {
                            ...
                            // Зберегти токен
                            if (data.token) {
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveToken"])(data.token);
                            ...
                            alert(`Помилка авторизації: ${errorData.message || response.status}`);
                        }
                    } catch (error) {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        ...
                        children: "Увійдіть через Telegram"
                    }, void 0, false, {
                        fileName: "[project]/src/app/login/page.tsx",
                        lineNumber: 96,
                        columnNumber: 9
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Для створення замовлень необхідно авторизуватись через Telegram"
                    }, void 0, false, {
                        fileName: "[project]/src/app/login/page.tsx",
                        lineNumber: 97,
                        columnNumber: 9
...
_s(LoginPage, "RYWW2VQvVApUUsipP0Ce7OkONog=", false, function() {
    return [
...
//# sourceMappingURL=_7fc15b19._.js.map